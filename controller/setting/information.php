...
class ControllerSettingInformation extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('setting/information', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['add'] = $this->url->link('setting/information/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('setting/information/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['informations'][] = array(
				...
				'edit'           => $this->url->link('setting/information/edit', 'token=' . $this->session->data['token'] . '&information_id=' . $result['information_id'] . $url, true)
			);
		}
		...
		$data['sort_title'] = $this->url->link('setting/information', 'token=' . $this->session->data['token'] . '&sort=id.title' . $url, true);
		$data['sort_sort_order'] = $this->url->link('setting/information', 'token=' . $this->session->data['token'] . '&sort=i.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('setting/information', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (!isset($this->request->get['information_id'])) {
			$data['action'] = $this->url->link('setting/information/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('setting/information/edit', 'token=' . $this->session->data['token'] . '&information_id=' . $this->request->get['information_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('setting/information', 'token=' . $this->session->data['token'] . $url, true);
