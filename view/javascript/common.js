...
$(document).ready(function() {
	...
	$(document).on('click', 'a[data-toggle=\'image\']', function(e) {
        ...
        //ImageAdd
        $(document).on('click', '#button-add-image', function(e) {
            e.preventDefault();
            var $element = $(this);
            ...
            $.ajax({
                    url: 'index.php?route=common/filemanager&token=' + getURLVar('token') + '&target=input-image' + $recipient + '&thumb=thumb-image' + $recipient,
                    dataType: 'html',
                    beforeSend: function() {
                    ...
                    success: function(html) {
                            ...
                            $('#modal-image').modal('show');
                            $($emptyDiv).insertBefore($element.parent());
                    }
            });
            $element.data('pointer', $recipient + 1);
        });
