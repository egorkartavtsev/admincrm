          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <label>Avito</label>  
                      <input type="text" name="width" value="<?php echo $width; ?>" placeholder="Ссылка на Avito" id="input-width" class="form-control" />
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-sm-6">
                      <label>Drom</label>    
                      <input type="text" name="height" value="<?php echo $height; ?>" placeholder="Ссылка на Drom" id="input-height" class="form-control" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group" style="display: none;">
                ...
                <div class="col-sm-10">
                  <input type="text" name="weight" value="" placeholder="" id="input-weight" class="form-control" />
                </div>
              </div>
              <div class="form-group">
