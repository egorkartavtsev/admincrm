          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmr_merch_r" value="<?php echo $webmoney_wmr_merch_r; ?>"
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmr_secret_key" value="<?php echo $webmoney_wmr_secret_key; ?>"
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmr_secret_key_x20" value="<?php echo $webmoney_wmr_secret_key_x20; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <span class="form-control" style="height:auto;"><?php echo $webmoney_wmr_result_url; ?></span>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <span class="form-control" style="height:auto;"><?php echo $webmoney_wmr_success_url; ?></span>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <span class="form-control" style="height:auto;"><?php echo $webmoney_wmr_fail_url; ?></span>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="webmoney_wmr_order_confirm_status_id" id="input-order_confirm_status" class="form-control">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="webmoney_wmr_order_status_id" id="input-order_status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if (!isset($order_status['order_status_id'])) continue; ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="webmoney_wmr_order_fail_status_id" id="input-order_fail_status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if (!isset($order_status['order_status_id'])) continue; ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmr_minimal_order" value="<?php echo $webmoney_wmr_minimal_order; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmr_maximal_order" value="<?php echo $webmoney_wmr_maximal_order; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmr_sort_order" value="<?php echo $webmoney_wmr_sort_order; ?>"
            ...
            <div class="tab-pane" id="tab-log">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="hidden" name="webmoney_wmr_log_filename" value="<?php echo $log_filename ?>" />
