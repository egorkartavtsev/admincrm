...
class ModelUserUser extends Model {
	public function addUser($data) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "user` SET "
                        ...
                        . "userAL = '" . $this->db->escape($data['userAL']) . "', "
                        . "image = '" . $this->db->escape($data['image']) . "', "
                        . "status = '" . (int)$data['status'] . "', "
                        . "date_added = NOW()");
                $user = $this->db->getLastId();
                $this->db->query("INSERT INTO ".DB_PREFIX."user_customs SET user_id = ".$user);
		return $user;
	}
	...
	public function getUser($user_id) {
		$query = $this->db->query("SELECT *, (SELECT ug.text FROM `" . DB_PREFIX . "user_group` ug WHERE ug.user_group_id = u.user_group_id) AS user_group FROM `" . DB_PREFIX . "user` u WHERE u.user_id = '" . (int)$user_id . "'");
