...
//				}
				...
				$product_data[] = array(
					...
					//'weight'          => ($product_query->row['stock'] + $option_weight) * $cart['quantity'],
					//'weight_class_id' => $product_query->row['weight_class_id'],
					//'length'          => $product_query->row['modR'],
					//'width'           => $product_query->row['width'],
					//'height'          => $product_query->row['donor'],
...
//	public function addCompl($complect_id, $quantity = 1, $option = array(), $recurring_id = 0) {
...
//	}
	...
	public function getTotal() {
		...
		foreach ($this->getProducts() as $product) {
			$total += $this->tax->calculate($product['price'], FALSE, $this->config->get('config_tax')) * $product['quantity'];
		}
